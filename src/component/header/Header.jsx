       ...
       <header className={`header ${mobileMenu?"mobileView":""} ${show}`}>
          <ContentWrapper>
              ...
              <ul className="menuItems">
                <li className="menuItem" onClick={()=> NavigationHnadler("movie")}>Movies</li>
                <li className="menuItem" onClick={()=>NavigationHnadler("tv")}>TV Shows</li>
